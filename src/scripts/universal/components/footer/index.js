    ...
    <footer className="main-footer">
      <div className="container d-flex justify-space-between align-center">
        ...
        <div className="social">
          <a href="https://www.facebook.com/petsbourg" target="_blank"
             className="btn social-btn btn-circle small btn-facebook margin-h-10">
            <FacebookIcon width={7} color="#BDBDBD"/>
          </a>
          <a href="https://www.facebook.com/petsbourg" target="_blank"
             className="btn social-btn btn-circle small btn-twitter margin-h-10">
            <TwitterIcon width={12} color="#BDBDBD"/>
          </a>
          <a href="https://www.facebook.com/petsbourg" target="_blank"
             className="btn social-btn btn-circle small btn-google margin-h-10">

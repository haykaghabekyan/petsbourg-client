...
const PenIcon = ({ color="#27AE60", width=14, height=14 }) => {
    return (
        <svg width={width} fill={color} viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
